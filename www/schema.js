...
function generateDDL(email, password) {
    ...
    sql_init_admin_user = 'insert into users (id, role, name, email, verified, image_url, locked_util, created_at, updated_at, version) values (\'' + id + '\', 0, \'Admin\', \'' + email + '\', 1, \'/static/img/user.png\', 0, 1394002009000, 1394002009000, 0);\n\n' +
